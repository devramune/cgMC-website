...
import sty from "./PlasmicCallToActionSection.module.css"; // plasmic-import: IiR3jQqv0epaDK/css
...
function PlasmicCallToActionSection__RenderFunc(props: {
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          image: {
            src: "/plasmic/coralia_mc/images/meeting.jpeg",
            fullWidth: 2916,
            fullHeight: 1787,
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__cY3JD)}>
        <div
        ...
        <div className={classNames(projectcss.all, sty.freeBox__w0JRg)}>
          <p.Stack
            as={"div"}
            hasGap={true}
            className={classNames(projectcss.all, sty.freeBox__we07)}
          >
            <p.Stack
              as={"div"}
                ...
                defaultContents: (
                  <React.Fragment>
                    <p.Stack
                      as={"div"}
                      hasGap={true}
                      className={classNames(projectcss.all, sty.freeBox__yv3B)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
