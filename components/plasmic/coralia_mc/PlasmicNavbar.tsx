...
import sty from "./PlasmicNavbar.module.css"; // plasmic-import: WHKZkoQfDP8713/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__hRPuu)}
      >
        {true ? (
          <Logo
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__iqlSk)}
        >
          <Button
          ...
          <Button
            className={classNames("__wab_instance", sty.button__sgBV)}
            color={"navLink" as const}
        ...
        {false ? (
          <div className={classNames(projectcss.all, sty.freeBox__oUoDk)}>
            <button
              className={classNames(
                projectcss.all,
                projectcss.button,
            ...
            <Button className={classNames("__wab_instance", sty.button__uktae)}>
              {"Log in"}
            </Button>
          </div>
        ) : null}
      ...
      <Button
        className={classNames("__wab_instance", sty.button___2EtBz)}
