...
import sty from "./PlasmicListItem.module.css"; // plasmic-import: NcN0Aa5WBeOCIo/css
  ...
  return (
    ...
    >
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <CheckCircleIcon
            className={classNames(projectcss.all, sty.svg___2Qu0Y)}
            role={"img"}
          />
        ),
