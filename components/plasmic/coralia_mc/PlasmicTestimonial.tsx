...
import sty from "./PlasmicTestimonial.module.css"; // plasmic-import: IXDCWWj6IE9vKA/css
  ...
  const args = React.useMemo(
    () =>
      Object.assign(
        {
          image: {
            src: "/plasmic/coralia_mc/images/tracy.png",
            fullWidth: 500,
            fullHeight: 500,
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__j4FiR)}
      >
        {p.renderPlasmicSlot({
          defaultContents:
      ...
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__jfMqz)}
      >
        <p.PlasmicImg
        ...
        <p.Stack
          as={"div"}
          hasGap={true}
          className={classNames(projectcss.all, sty.freeBox__pkRI)}
        >
          <div className={classNames(projectcss.all, sty.freeBox__bhcvc)}>
            {p.renderPlasmicSlot({
